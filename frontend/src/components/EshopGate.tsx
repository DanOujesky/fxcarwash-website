...
// Module-level proměnná — jednou nastavená platí po celou dobu JS session (i přes navigace)
let granted = false;

// Inicializace: spustí se jednou při načtení modulu, před jakýmkoliv renderem
if (PREVIEW_CODE) {
  ...
  return (
    <div className="min-h-screen pt-[121px] sm:pt-[185px] body-bg-color text-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 text-center gap-6">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold tracking-wide">Připravujeme pro vás</h1>
...
export default function EshopGate({ children }: { children: React.ReactNode }) {
  // granted (module-level) || sessionStorage fallback (pro případ HMR reloadu modulu)
